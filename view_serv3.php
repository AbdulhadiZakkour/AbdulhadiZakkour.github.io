...
<form method="post" class="my">
    <center><h2>رخصة انشائات</h2></center>
    <hr>
    ...
    <div class="form-row justify-content-center">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="number" name="flat" readonly  value="<?php echo $clientSet['flat_space'];?>" class="form-control " id="inputAddress " placeholder=" " tabindex="31 ">
        </div>
    </div>
    <div class="form-row justify-content-center">
        <div class="form-group col-md-2">
...
-->
    ...
    <div class="form-row justify-content-center">
        <div class="form-group col-md-6">
            ...
            <input type="number" min="0.01" step="0.01" readonly max="2500" onmouseleave="myFunction()" name="lice2" value="<?php echo $servSet['exec_fee'];?>" class="form-control" id="txt1" placeholder="0">
        </div>
        <div class="form-group col-md-6">
            <label for="inputPassword4">رسوم الترخيص</label>
            <input type="number" min="0.01" step="0.01" readonly max="2500" name="lice1" value="<?php echo $servSet['lice_fee'];?>" class="form-control" id="txt2" placeholder="0">
        </div>
    </div>
    <br>
    <center>
        <div class="from-row text-right">
            <div class="from-group col-md-6 text-right">
                ...
                <div class="from-group col-md-6 text-right">
                    <textarea style="height: 50px; width: 100px;max-height: 50px;max-width: 100px;" name="total" value="<?php echo $servSet['total'];?>" class="form-control" readonly id="demo"> </textarea>
                </div>
    ...
    <center><a href="index.php" type="submit" id="submit" name="submit" style="margin-top: 15px" class="btn btn-primary">الرجوع لصفحة الرئيسية</a></center>
