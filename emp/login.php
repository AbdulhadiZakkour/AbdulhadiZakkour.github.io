...
if(isset($_POST['submit'])){
    ...
    $query = "select * from emp where emp_email = '$email' AND emp_password = '$password'";
    $result   = mysqli_query($conn,$query);
    $empSet = mysqli_fetch_assoc($result);

    if($empSet['emp_id']){
        $_SESSION['emp_id'] = $empSet['emp_id'];
    ...
    <div class="container">
        <div class="login-content">
            <div class="login-logo">
                <a href="login.php">
                   <!-- <img class="align-content" src="../admin/images/logooo.png" style="" width="80%" height="170" alt="">-->
                    ...
                    <div><span class="color-b" style="font-size: 35px">بلدية باب عمان</span><br>
                        <span style="color: white;font-size: 25px">بوابة الموظفين</span> </a></div>
